...
[BuildOptions]
  *_*_*_CC_FLAGS = -DSOC_TYPE=$(SOC_TYPE) -DAB_SLOT_SUPPORT=$(AB_SLOT_SUPPORT) -DHAS_BUILD_IN_KEYBOARD=$(HAS_BUILD_IN_KEYBOARD) -DHAS_MLVM=1
...
[PcdsFixedAtBuild]
  ...
  gSiliciumPkgTokenSpaceGuid.PcdSmbiosSystemRetailModel|"dagu"
  gSiliciumPkgTokenSpaceGuid.PcdSmbiosSystemRetailSku|"Pad_dagu"
